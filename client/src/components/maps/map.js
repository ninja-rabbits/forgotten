...
class Map extends React.Component {
  ...
  render() {
    ...
    const lives = this.state.lifeImg.map((life, index) =>
      <img src={life} key={index} style={{maxHeight:'40px', maxWidth:'40px', marginLeft:'20px'}}/>
    );
    ...
    if (!this.state.clickedQuest && this.props.map === '0') {
      return (
        <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
          ...
          <RaisedButton label="Return to Maps" onClick={() => this.props.handleReturnToMapsClick()} backgroundColor='#E94F37' labelColor='#F6F7EB' style={{float: 'right', width: '160px', margin:'20px'}}/>
      ...
      return (
        <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
          ...
          <RaisedButton label="Return to Maps" onClick={() => this.props.handleReturnToMapsClick()} backgroundColor='#E94F37' labelColor='#F6F7EB' style={{width: '160px', margin: '20px'}}/>
          <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 800 515" style={{width: '1000px', enableBackground: 'new 0 0 800 515'}} xmlSpace="preserve">
